                    ...
                    <div class="col profilemain">
                        <div class="row 12 profileOptions">
                            <?php if ($match == FALSE && $this->session->userdata['user_id'] != $user['User_id']) : ?>
                                <a class="acontrastlink" href="<?php echo base_url('/users/addfriend/' . $user['User_id']); ?>">Add Friend</btn></a>
                            <?php endif ?>
                            <!--Show edit profile button if session user_id matches the profile User_id-->
                            <?php if ($this->session->userdata['user_id'] == $user['User_id']) : ?>
                                <a class="acontrastlink" href="<?php echo base_url('/users/editprofile/' . $user['User_id']); ?>">Edit Profile</btn></a>
                            <?php endif ?>
                        </div>
                        <!--Profile Information-->
                        ...
                        <?php if ($this->session->userdata['user_id'] == $user['User_id']) : ?>
                            ...
                            <a class="acontrastlink" href="<?php echo base_url('/users/requests/'); ?>">Friend requests (<?php echo count($requests) ?>)<br><br></btn></a>
                        <?php endif ?>
