                    ...
                    <div class="col-12">
                        ...
                        <?php if ($match == TRUE || $this->session->userdata['user_id'] == $user['User_id']) : ?>
                            <div class="row-12 flex">
                                ...
                                <?php foreach ($friends as $friend) : ?>
                                    <div class="col-2">
                                        <a href="<?php echo base_url('/users/viewprofile/' . $friend['Usertwo_id']); ?>"><div class="col-12 profileFriends"><img class="profPicfriend" src="<?php echo base_url('assets/images/' . $friend['Picture']); ?>" alt="Profile Picture"><p><?php echo $friend['FirstName'] . ' ' . $friend['LastName'] ?></p>
                                        </div></a>
                                    </div>
                                <?php endforeach; ?>
                            </div>
