...
<body>
                ...
                <div class="mainfeeds">
                    ...
                    <?php foreach ($posts as $post) : ?>
                        <div class="col-12 post">
                            <div class="posttop">
                                <div class="row g-0">
                                    ...
                                    <div class="col-11 col-md-11 col-lg-11 name postdetails">
                                        ...
                                        <!-- Delete post link if id and session id match -->
                            ...
                            <!-- Match variable to link like with user, if liked, change wording on like button (cannot be placed below with affecting functionality) -->
                            <div class="row interact g-0">
    ...
    <script>
        ...
        // When the user clicks on popup, close the modal
